...
public partial class admin_delete : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        if (chkallow.Checked)
        {
            ...
            msg.Body = "Hi, Thanks For Your Registration at SkyRise Residency,But Your Authentication is Failed. Please Provide Correct Data, Thank You.  ";
            ...
            re.conopen();
            re.qry = "Delete From owner_mstr where owner_name='" + txtname.Text + "'";
            re.uid();
            re.conclose();
